...
| HCSC Indicator Summary | `/dhis2/hcsc-indicators` — Phase 0–2 read-only registry + batched analytics Overview/report (`hub/hcsc_indicators/`, `config/hcsc_indicators.yaml`); no formula engine |
